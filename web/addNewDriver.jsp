...
<form method="get" action="MainServlet">
    <div align=right>
        <a href="addNewDriver.jsp?theLocale=en_US"><img src="img\us.png"></a>&nbsp;&nbsp;
    ...
    <div align="center">
        ...
        <table width="33%" border="0">
            <tr>
                <td align="center">
                    <fmt:message key="label.addnewdriver"/><br> <input type="text" name="driverName" required><br>
                </td>
            </tr>
            <tr>
                <td align="center">
                    <br/>
                    <input name="command" value="ADDDRIVER" type="hidden">
                    <input name="theLocale" value="${theLocale}" type="hidden">
                    <input class="btn btn-secondary" type="submit" value="<fmt:message key="label.addnewdriver"/>">
                </td>
            </tr>
        </table>
        <br/><br/>
